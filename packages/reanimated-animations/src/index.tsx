...
export function createAnimations<A>(animations: A): { useStyle: any; animations: A } {
  // , isHovered, isPressed, isExiting
  const useStyle = (
    props: Object,
    { style, hoverStyle, pressStyle, exitStyle, onDidAnimate, delay }
  ) => {
    ...
    return useAnimatedStyle(() => {
      ...
      for (const key in mergedStyles) {
        ...
        let { delayMs } = animationDelay(key, transition, delay)

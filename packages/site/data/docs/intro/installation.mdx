...
We have a full example of a [plain, webpack-only repo here](https://github.com/tamagui/tamagui/tree/master/packages/test-sandbox), which should capture the complete configuration more accurately.

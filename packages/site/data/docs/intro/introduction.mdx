...
Tamagui's goal is simple: **let you share a lot more code between web and native apps, without sacrificing look, feel or performance**. It turns natural syntax for **responsive styles**, **themes**, and **inline styles** into, on the web: atomic classes, media queries, and CSS variables, and on native to an optimized StyleSheet.create.
